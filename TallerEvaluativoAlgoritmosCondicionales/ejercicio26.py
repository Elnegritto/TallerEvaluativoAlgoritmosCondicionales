#26. Escriba un programa en Python que acepte la opción de dos jugadoras ena. Piedra-Papel-Tijera y decida el resultado (solución).b. Entrada: persona1=piedra; persona2=papelc. Salida: Gana persona2: El papel envuelve a la piedra
