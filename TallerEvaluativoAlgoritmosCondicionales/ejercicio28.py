#28. La tienda sofia valida el valor de la compra si el valor de la compra es mayora 40 mil , si es así debe indicar el color de la balota(roja 10%, blanca 15%, negra 20%,amarilla 20%, verde 30%) según el color se aplica el descuento, sedebe mostrar el descuento y el valor neto a pagar.Si los valores son menores que 40 no va aplicar ningún descuento.
